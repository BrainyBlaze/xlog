...
from pyxlog._native import (
    ...
    RelationMetadataError as RelationMetadataError,
...
# Package runtime extensions installed on the imported native classes:
# def evaluate_async(self, *args: Any, **kwargs: Any) -> AsyncEvaluation: ...
# def progress_stats(self) -> dict[str, Any]: ...
...
# CompiledLogicProgram epistemic extensions (declared natively; see _native.pyi):
# def evaluate_conditioned(self, prob_source: str, memory_mb: Optional[int] = None) -> EpistemicEvalResult: ...
# def epistemic_evidence(self) -> EpistemicEvidence: ...
# EpistemicEvalResult.log_z_e is the exact log-evidence of the conditioned query program.
# EpistemicEvalResult.trace keys include gpu_conditioned_know_evidence_facts and
