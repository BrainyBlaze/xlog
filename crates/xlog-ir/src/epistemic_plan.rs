...
///
/// This is a structural plan declaration. Runtime eligibility separately
/// requires positive evidence from the executed GPU route.
/// Exhaustive consumers must be updated if another backend is introduced.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// It is a structural declaration, not an observation of fallback activity.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
