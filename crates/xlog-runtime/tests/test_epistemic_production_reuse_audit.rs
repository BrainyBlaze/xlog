...
fn production_reuse_audit_reports_no_parallel_epistemic_engines() {
    ...
    assert!(integration
        .contains("accepted_quaternary_not_possible_membership_matches_gpt_oracle_parity"));
    assert!(integration
        .contains("accepted_quaternary_possible_and_not_know_memberships_match_gpt_oracle_parity"));
    ...
    assert!(integration.contains("accepted_split_quaternary_all_operators_match_gpt_oracles"));
    assert!(
    ...
    assert!(integration
        .contains("accepted_split_all_binary_operator_batch_rejects_cpu_fallback_counters"));
    assert!(integration.contains(
    ...
    assert!(integration.contains("accepted_gpu_execution_result_rejects_row_count_only_membership"));
    assert!(integration
        .contains("accepted_split_quaternary_all_operator_batch_rejects_hot_path_host_transfers"));
    assert!(integration.contains("accepted_gpu_execution_result_rejects_hot_path_host_transfers"));
    ...
    assert!(integration.contains(
        "accepted_split_all_binary_operator_batch_gates_probabilistic_pir_cnf_and_exact_evaluation_paths"
    ));
    ...
    assert!(integration
        .contains("accepted_split_quaternary_not_possible_batch_gates_solver_lifecycle_path"));
    assert!(integration
        .contains("accepted_split_quaternary_all_operator_batch_gates_solver_lifecycle_path"));
    assert!(integration
        .contains("accepted_split_all_binary_operator_batch_gates_solver_reuse_and_maxsat_paths"));
    assert!(integration.contains(
        "accepted_split_all_binary_operator_batch_gates_solver_search_scheduler_and_portfolio_paths"
    ));
    assert!(integration.contains(
        "accepted_split_quaternary_not_possible_batch_gates_solver_reuse_and_maxsat_paths"
    ));
    assert!(integration.contains(
        "accepted_split_quaternary_all_operator_batch_gates_solver_reuse_and_maxsat_paths"
    ));
    assert!(integration.contains(
        "accepted_split_quaternary_not_possible_batch_gates_solver_search_scheduler_and_portfolio_paths"
    ));
    assert!(integration.contains(
    ...
    assert!(integration
        .contains("accepted_quaternary_not_possible_gates_solver_search_and_scheduler_paths"));
    assert!(integration.contains(
