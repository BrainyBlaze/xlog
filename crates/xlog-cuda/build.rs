...
pub struct EmbeddedKernelPtx {
    pub name: &'static str,
    pub ptx: &'static str,
}

pub const EMBEDDED_PORTABLE_PTX: &[EmbeddedKernelPtx] = &[];

pub fn portable_ptx(_name: &str) -> Option<&'static str> {
    None
}

pub const CANONICAL_ARTIFACT_HASHES: &[(&str, u64)] = &[];

pub fn canonical_artifact_hash(_file_name: &str) -> Option<u64> {
    None
}
"#;
    fs::write(out_dir.join("embedded_kernel_data.rs"), source)
