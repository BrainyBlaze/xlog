...
pub use semantic_transition::{
    ...
    SemanticStateRecord, SemanticStateRole, SemanticTaskContentIdentity,
    SemanticTaskContentProjection, SemanticTaskEvaluation, SemanticTaskEvaluationSpec,
    SemanticTaskFacts, SemanticTaskGoalWitness, SemanticTaskObservation,
