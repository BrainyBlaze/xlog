...
pub use provider::{
    ...
    CudaKernelProvider, FjDeltaCols, FjNode, FjPlan, FjSubAtom, IlpExactNaryPatterns,
    IlpExactNaryRequest, JoinIndexV2, JoinType, CIRCUIT_MODULE, DEDUP_MODULE, FILTER_MODULE,
