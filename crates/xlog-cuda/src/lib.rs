...
pub use semantic_transition::{
    ...
    SemanticReplayMaterial, SemanticRngBinding, SemanticSourceMapping, SemanticStateRecord,
    SemanticStateRole, SemanticTaskEvaluation, SemanticTaskEvaluationSpec, SemanticTaskFacts,
