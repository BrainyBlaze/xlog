...
description: "How xlog recognizes, plans, and dispatches worst-case optimal multiway joins on the GPU, from RIR promotion through CUDA provider launches."
---
...
gate evidence: aggregate-fused WCOJ measurements (6.05x /
