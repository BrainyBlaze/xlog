...
description: "XLOG's cost-based query optimizer: join ordering, predicate pushdown, common-subexpression elimination, adaptive re-optimization, and the unified statistics layer."
---
...
See [Adaptive Indexing](/architecture/adaptive-indexing) for the runtime manager.
...
- [Adaptive Indexing](/architecture/adaptive-indexing) — HISA index management
