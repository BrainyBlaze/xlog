...
description: "Design for distributed hash joins across multiple GPUs using hash-based partitioning; not yet shipped."
---

<Warning>This is a design document. Multi-GPU distributed joins are not shipped; single-GPU `hash_join_v2` is the production path.</Warning>
...
tracked as future roadmap work (see the [Roadmap](/architecture/roadmap)).
</Note>
