...
description: "Declare typed predicates, state facts, and derive new relations with rules — the foundation of every XLOG program."
---
...
Running a program evaluates every rule to a fixpoint, then prints the queries:
