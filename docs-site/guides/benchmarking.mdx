---
title: "Benchmarks"
description: "XLOG's performance benchmarking suite, methodology, and baseline metrics, with an explicit distinction between measured results and aspirational targets."
---
