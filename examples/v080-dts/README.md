# v0.8.0 DTS Example Suite

Focused post-close hardening examples for the v0.8.0 DTS-DLM ML/Python
...
|---|---|---|
| `01_async_streaming_reachability` | Recursive DTS-style graph query | `LogicProgram`, sessions, `evaluate_async`, `evaluate_stream`, chunked result tensors, memory/progress/graph/host-transfer stats |
...
| `04_native_exact_induction` | DTS-shaped exact ILP topology selection | learnable `.xlog`, `IlpProgramFactory`, `induce_exact(..., backend="native")`, Python/native parity |
