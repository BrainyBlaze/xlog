...
These features and controls have been available since 0.10.0. See the
[factorized execution guide](/architecture/factorized-execution) for details.
</Note>

| Variable | Values | Gates | Effect |
|---|---|---|---|
