...
Architecture reference for contributors: XLOG's factorized routes (aggregate-fused WCOJ, Free Join, and recursive delta) that avoid materializing large intermediate joins. Available since 0.10.0.
...
[WCOJ tuning](/guides/wcoj-tuning) instead. That is the user-facing home for
...
These routes have been available since 0.10.0.
...
three or more atoms that do not use a dedicated triangle, 4-cycle, or clique
kernel.
...
Record the runtime version with any such example. These routes have been available
since 0.10.0; earlier packages do not include them.
