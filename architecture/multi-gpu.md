...
- **Factorized routes** — join paths that keep intermediate results in a
  compressed, factored form rather than fully expanded. These single-GPU routes
  have been available since 0.10.0.

<Warning>
This is design-state documentation. Distributed join execution, cross-device
partitioning, and multi-GPU WCOJ are not implemented.
</Warning>
