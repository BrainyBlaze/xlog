...
PyTorch or JAX computation consumes them without a copy. You can confirm residency held
on a run: the tensor XLOG hands back reports a CUDA device (`tensor.device`), which means
