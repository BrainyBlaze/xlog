...
computing the join first and aggregating after — has been available since 0.10.0.
Treat its speedup as a development-branch measurement collected before release,
not as a measurement collected from a release artifact.
</Note>
