...
generation of the code. They have since been reproduced under the same protocol on
different hardware (an RTX 3090), where the steady epoch landed within 7% of the
`~0.25 s` above.
