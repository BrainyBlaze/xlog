...
their compatible clauses are merged into one relation. This also applies when selective
imports name that predicate in more than one module. Repeated predicate declarations must
have compatible schemas, as described below.
