...
description: "Carry a small ordered collection of values in one column, pull it apart with head/tail patterns, and use XLOG's compile-time meta-predicates to inspect and collect terms."
---
