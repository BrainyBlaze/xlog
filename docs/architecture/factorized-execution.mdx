...
description: "Architecture reference for contributors: XLOG's factorized routes (aggregate-fused WCOJ, Free Join, and recursive delta) that avoid materializing large intermediate joins. Available since 0.10.0."
---
