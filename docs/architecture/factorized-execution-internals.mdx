...
description: "Implementation notes for the factorized routes available since 0.10.0: WCOJ aggregate fusion, Free Join frontiers, and dense or sparse recursive deltas."
---
