...
|---|---|---|---|
| M090_EIR.6 production route | accepted epistemic forms have a production lowering route | SUPERSEDED | Executable route exists after the semantic contract; direct `xlog run` lowering still rejects epistemic literals. |
