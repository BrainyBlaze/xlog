...
This artifact records accepted runtime fixtures proving unary and binary
variable-bound nonzero-arity tuple membership can filter final output rows on
device. It is not a closure claim for `G090_GPU`, `G090_CERT`, or `G090_CLOSE`.
...
- Multiple-epistemic-literal final-row filters still require broader coverage.
