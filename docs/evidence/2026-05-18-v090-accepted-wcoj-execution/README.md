...
- It satisfies accepted unary, possible-operator, not-possible-operator,
  binary, multi-membership, missing-required multi-membership, and negated
  `not know` variable-bound nonzero-arity membership fixtures.
