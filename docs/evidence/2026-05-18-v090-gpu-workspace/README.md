...
evidence where needed, and add distinct-candidate learned-clause validity plus
broader probabilistic knowledge-compilation coverage with zero CPU fallback
counters.
