...
and accepted unary/binary/multi-membership variable-bound final-row filtering
for nonzero-arity membership.
...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 14 passed, 0 failed |
