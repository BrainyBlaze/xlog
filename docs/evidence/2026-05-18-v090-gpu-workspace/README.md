...
and accepted unary/binary variable-bound final-row filtering for nonzero-arity
membership.
...
traces and broader probabilistic knowledge-compilation/end-to-end traces with
