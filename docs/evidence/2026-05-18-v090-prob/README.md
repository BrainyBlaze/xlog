...
CPU probability recomputation. The same accepted split-batch evidence now
...
- The production adapter is partial source/program exact-compile,
  ...
  split-batch quaternary parsed-program not-possible evidence reuse,
