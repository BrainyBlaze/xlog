...
- The production adapter is partial source/program exact-compile,
  PIR/CNF, single-record and two-record query-evaluation, single-record and two-record gradient-evaluation, zero-arity and concrete
