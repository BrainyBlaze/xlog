...
query probabilities differ by accepted world-view evidence. Conditioned source
and parsed-program gradient APIs now run through the same accepted-world-view
evidence boundary, including a two-record parsed-program gradient batch.
