...
epistemic assumptions, including false assumptions from `not know`, into exact
...
- The production adapter is partial source/program exact-compile,
  ...
  source/program bounded compile/evaluate reuse, two-record accepted source
  batch reuse, two-record negative conditioned source batch reuse, and
