...
operator evidence plus false assumptions from `not know`, into exact
...
- The production adapter is partial source/program exact-compile,
  ...
  operator-level possible/not-possible conditioned source evaluation,
