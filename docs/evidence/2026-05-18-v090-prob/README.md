...
conditioned paths. Ternary source-conditioned and quaternary parsed-program
accepted probabilistic evidence now record aggregate and source/program-specific
nonzero-arity evidence counts plus maximum conditioned evidence arity in the
production trace.
