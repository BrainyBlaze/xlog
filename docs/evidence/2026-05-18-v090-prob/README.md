...
world-view evidence. The full query-conditioned probabilistic matrix over
accepted world views is not complete.
...
- The production adapter is partial source/program exact-compile,
  ...
  two-record conditioned source/parsed-program query batch evidence only.
