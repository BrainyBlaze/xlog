...
conditioned paths. Ternary accepted probabilistic evidence now records
aggregate and source/program-specific nonzero-arity evidence counts plus maximum
