...
probability recomputation. The same two-component quaternary split batch
...
- The production adapter is partial source/program exact-compile,
  ...
  split-batch quaternary possible/not-know conditioned source evidence,
