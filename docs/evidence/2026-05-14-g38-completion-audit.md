...
**Response 2 code remediation commit:** `7376ce52`
...
| KPI-P1.6 W5.2 corpus within `+-10%` | M_INT.4 Response 2 remediation evidence | NOT MET under the original historical-ratio gate across the three-invocation corpus. The rejected timing-shaping evidence is superseded. |
...
See `docs/evidence/2026-05-14-g38-int-mint4-response2-three-run.tsv` for the
36 per-run M_INT.4 rows behind the Response 2 re-baseline corpus.
