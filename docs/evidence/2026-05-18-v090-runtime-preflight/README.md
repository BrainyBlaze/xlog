...
| Accepted WCOJ dispatch | `test_epistemic_gpu_wcoj_execution` proves accepted K5, K7, and K8 epistemic reductions reach certified production WCOJ dispatch and final row materialization. |
...
fixtures, extend helper/skew runtime evidence where required, extend
