...
| M090_GPU.6 launch evidence | nonzero GPU launch counts and timings | PARTIAL | Candidate-generation, propagation, candidate-validation, and materialization traces record nonzero launches with CUDA-event elapsed timing; stable-model validation/final materialization timing is still missing. |
