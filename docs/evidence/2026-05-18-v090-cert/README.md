...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 12 passed, 0 failed |
...
- accepted-world-view probabilistic evidence on broader GPU-native
  knowledge-compilation/end-to-end paths with zero CPU-only recomputation.
