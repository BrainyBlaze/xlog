...
| M090_CERT.8 GPU-native evidence | GPU launch counts, kernel timings, and zero CPU fallback counters | BLOCKED | GPU-plan, workspace, preflight, and counter-guard contracts exist, but no epistemic GPU launch/counter evidence exists yet. |
