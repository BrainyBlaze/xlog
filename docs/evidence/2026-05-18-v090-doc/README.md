...
records the current closure status. The documentation and evidence set now
distinguishes current accepted-path evidence from dated historical blockers. The
recommendation is `MERGE_READY`; push, tag, release-board update, merge, or
