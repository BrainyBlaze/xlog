...
recommendation remains `HOLD_FOR_FIXES` until the 215-path dirty worktree is
checkpointed with stable sub-goal commit SHAs and the final validation bundle is
rerun.
