...
- accepted solver production adapters that gate GPU CDCL SAT/UNSAT, reusable
  ...
  accepted split-batch solver lifecycle, learned-clause reuse, MaxSAT, and portfolio dispatch with batch/component counters,
