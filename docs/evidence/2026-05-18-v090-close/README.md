...
- accepted solver production adapters that gate GPU CDCL SAT/UNSAT, reusable
  ...
  solver lifecycle with accepted `know`/`possible`/`not possible`/`not know`
  component evidence counters, learned-clause reuse, MaxSAT,
