...
| G090_SOLVER | BLOCKED | Accepted GPU runtime evidence can gate GPU CDCL SAT, but MaxSAT, portfolio execution, and full assumption lifecycle traces are not wired to epistemic candidates. |
