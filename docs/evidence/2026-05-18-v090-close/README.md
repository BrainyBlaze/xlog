...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 107 passed, 0 failed |
...
- accepted-world-view probabilistic evidence fixtures and production adapter
  ...
  counters, including an all-binary-operator split-batch conditioned source
  query fixture,
