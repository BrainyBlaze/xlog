...
- accepted solver production adapters that gate GPU CDCL SAT/UNSAT, reusable
  ...
  combined lifecycle-plus-MaxSAT, accepted split-batch solver lifecycle, learned-clause reuse, MaxSAT,
...
- broader accepted solver semantic integration beyond the current combined
  lifecycle, bounded scheduler, split-batch scheduler, and portfolio fixtures;
