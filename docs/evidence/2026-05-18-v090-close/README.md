...
| G090_G91 | PASS for semantic oracle plus one accepted runtime fixture | Compatibility fixtures pass and explicit self-supported `possible` reaches accepted GPU runtime execution, but full GPU parity remains unproven. |
