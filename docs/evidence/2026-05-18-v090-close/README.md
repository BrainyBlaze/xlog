...
- device-derived semantic trace accounting that reads bounded rejection-reason
  ...
  including bounded FAEEL, G91, unary operator, binary operator, quaternary generic-arity, multi-membership, and
