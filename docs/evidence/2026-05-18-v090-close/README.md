...
- accepted-world-view probabilistic evidence fixtures and production adapter
  ...
  evidence conditioning, two-record conditioned source query batches, PIR/CNF
  encoding, query evaluation, and gradient evaluation.
