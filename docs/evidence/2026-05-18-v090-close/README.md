...
- device-derived semantic trace accounting that reads bounded rejection-reason
  ...
  including bounded FAEEL, G91, and split-component GPU-vs-GPT oracle trace
  parity fixtures;
