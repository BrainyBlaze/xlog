...
- accepted-world-view probabilistic evidence fixtures and production adapter
  ...
  split-batch conditioned source exact evaluation with accepted batch/component
  counters,
...
- broader accepted-world-view probabilistic coverage beyond the bounded
  split-batch conditioned query, conditioned query/gradient, and PIR/CNF GPU-native knowledge-compilation
