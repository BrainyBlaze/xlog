...
four-component split quaternary all-operator batch now also reaches conditioned
source/program exact-query and source/program gradient evidence with one
accepted `know`, `possible`, `not possible`, and `not know` counter and zero CPU
