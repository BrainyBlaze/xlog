...
- runtime counter guard that refuses to certify WCOJ evidence from preflight
  ...
  fails closed unless compiler-created helper relation rules and WCOJ scans are
  present; accepted K5/K6/K7/K8 evidence observes production dispatch counters
  ...
  helper-scan counts inside the dispatch-certified trace, and K6 certifies
...
- broader nonzero GPU launch counts and kernel timings for actual stable-model
  ...
  binary/multi-membership and `not know` accepted fixtures;
