...
single-result possible/not-know evidence also now reaches source and
parsed-program PIR/CNF plus already-compiled exact query/gradient adapters. These are
...
- accepted-world-view probabilistic evidence fixtures and production adapter
  ...
  quaternary possible/not-know source and parsed-program PIR/CNF and
  already-compiled exact query/gradient fixtures,
...
- broader accepted-world-view probabilistic coverage beyond the bounded
  ...
  two-record source/program PIR/CNF, exact query/gradient, and PIR/CNF
