...
- device-derived semantic trace accounting that reads bounded rejection-reason
  ...
  including bounded FAEEL, G91, unary operator, binary operator, multi-membership, and
