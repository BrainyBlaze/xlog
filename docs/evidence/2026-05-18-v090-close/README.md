...
- accepted-world-view probabilistic evidence fixtures and production adapter
  ...
  split-batch conditioned source/program exact evaluation with accepted batch/component
  counters,
...
- broader accepted-world-view probabilistic coverage beyond the bounded
  split-batch conditioned source/program query, conditioned query/gradient, and PIR/CNF GPU-native knowledge-compilation
