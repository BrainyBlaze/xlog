...
|---|---|---|---|
| M090_SPLIT.1 graph construction | deterministic dependency graph | PASS | Sorted component fixture. |
| M090_SPLIT.2 valid split fixtures | 100 percent pass | PASS | `test_epistemic_split`: 3/3 passed. |
| M090_SPLIT.3 invalid split fixtures | typed rejection | PASS | `UnsupportedEpistemicConstruct` invalid coupling fixture. |
| M090_SPLIT.4 recomposition | recomposed output equals unsplit output on fixtures | PASS | `recomposed_rule_indices() == [0, 1]` fixture. |

## Coordination Notes

- This is bounded split planning, not parallel solver execution.
