...
counters,
accepted split-batch lifecycle, learned-clause reuse, MaxSAT, and portfolio dispatch with batch/component evidence counters,
...
portfolio dispatch plus split-batch learned-clause reuse, MaxSAT, and portfolio dispatch over the existing GPU
