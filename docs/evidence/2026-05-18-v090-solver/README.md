...
- `GpuSolverProductionAdapter`, a thin production-path adapter over the existing
  ...
  bounded single-result and two-record status-aware portfolio gates, learned-clause
