...
counters,
accepted split-batch lifecycle dispatch with batch/component evidence counters,
...
portfolio dispatch over the existing GPU CDCL adapter. Accepted G91 and default
