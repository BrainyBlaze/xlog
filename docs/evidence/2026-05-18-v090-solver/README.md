...
propagation, but it still lacks multi-candidate learned-clause lifecycle and
full solver release closure.
...
- The production adapter is partial accepted-runtime SAT, UNSAT,
  ...
  evidence only.
- Broader multi-candidate learned-clause lifecycle coverage and MaxSAT coverage
