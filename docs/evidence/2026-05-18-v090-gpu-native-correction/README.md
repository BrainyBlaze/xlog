...
reused without CPU solver search or CPU probability recomputation.
...
7. Feed accepted world-view evidence into the existing GPU-native
   ...
   operator-specific, all-binary-operator split-batch conditioned
