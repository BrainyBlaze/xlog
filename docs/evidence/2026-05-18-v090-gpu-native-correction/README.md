...
4. Add GPU-resident candidate/world-view/rejection buffer population and launch
   ...
   unary/possible/binary/multi-membership variable-bound final-row filtering
   fixtures plus negated `not know` absent-key filtering and operator metrics;
