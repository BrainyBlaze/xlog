...
7. Feed accepted world-view evidence into the existing GPU-native
   ...
   evidence preserves unary and binary false operator assumptions with negative-evidence
   trace counters, accepted G91/default FAEEL mode-specific evidence counters,
