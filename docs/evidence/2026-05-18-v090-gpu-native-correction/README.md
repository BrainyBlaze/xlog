...
3. Lower accepted EIR into production runtime plans instead of the current
   ...
   G38-B helper/histogram metadata count and timing reuse, and K7/K8
   K-clique preflight reuse of G39 planner metadata.
