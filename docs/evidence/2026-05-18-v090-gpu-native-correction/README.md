...
6. Replace CPU solver fixture search in accepted execution with GPU-native
   ...
   solver evidence counters, and accepted nonzero-arity tuple-key evidence
...
7. Feed accepted world-view evidence into the existing GPU-native
   ...
   operator-specific, all-binary-operator split-batch conditioned source query
   evidence, and accepted G91/default FAEEL mode-specific trace counters,
