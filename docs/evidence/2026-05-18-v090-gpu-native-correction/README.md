...
6. Replace CPU solver fixture search in accepted execution with GPU-native
   ...
   learned-clause reuse, split-batch MaxSAT, and split-batch portfolio dispatch,
...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 84 passed, 0 failed |
