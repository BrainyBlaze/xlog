...
6. Replace CPU solver fixture search in accepted execution with GPU-native
   ...
   multi-candidate MaxSAT, and bounded
   status-aware portfolio reuse through
   ...
   `solve_multi_candidate_weighted_maxsat_with_gpu_execution_results`, and
   `solve_portfolio_with_gpu_execution_result`; full accepted MaxSAT
