...
4. Add GPU-resident candidate/world-view/rejection buffer population and launch
   ...
   unary/possible/not-possible/binary/quaternary-generic/multi-membership variable-bound final-row
...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 65 passed, 0 failed |
