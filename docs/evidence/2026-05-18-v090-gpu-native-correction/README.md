...
4. Add GPU-resident candidate/world-view/rejection buffer population and launch
   ...
   transfer-budget tracing, and accepted unary/binary/multi-membership
   variable-bound final-row filtering fixtures; accepted rejection-reason
