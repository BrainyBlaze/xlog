...
4. Add GPU-resident candidate/world-view/rejection buffer population and launch
   ...
   transfer-budget tracing, and one accepted unary variable-bound final-row
   filtering fixture; accepted rejection-reason semantic population and broader
