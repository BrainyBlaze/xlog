...
6. Replace CPU solver fixture search in accepted execution with GPU-native
   ...
   bounded unary/binary operator lifecycle, accepted split-batch lifecycle and
   split-batch portfolio dispatch,
...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 82 passed, 0 failed |
