...
4. Add GPU-resident candidate/world-view/rejection buffer population and launch
   ...
   unary/possible/not-possible/not-know/binary/ternary-specialized/quaternary-generic/all-`know` multi-membership/mixed `know`-`possible` multi-membership variable-bound final-row
