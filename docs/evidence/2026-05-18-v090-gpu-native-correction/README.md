...
6. Replace CPU solver fixture search in accepted execution with GPU-native
   ...
   bounded unary/binary operator lifecycle, learned-clause arena publication, same-device-CNF
...
| `cargo test -p xlog-integration --test test_epistemic_gpu_wcoj_execution -- --nocapture` | PASS, 78 passed, 0 failed |
