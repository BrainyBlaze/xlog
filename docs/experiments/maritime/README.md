...
## Weighted-clause and duration-vocabulary columns (appended per PREREG_SOFT.md section (f))

The pre-registered soft-credit extension lives in
[`PREREG_SOFT.md`](PREREG_SOFT.md) (protocol, hypotheses, ceiling canon,
results, and the committed-bytes md5 pins of all four shipped
artifacts). Headline, same 5-fold pair-atom protocol as above:

| column | micro point F1 | P / R |
|---|---|---|
