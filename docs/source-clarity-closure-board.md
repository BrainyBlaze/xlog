...
Scanned files: 1430
Unresolved files: 283
Comment/prose artifact occurrences: 1805
Code/identifier artifact occurrences: 696
...
| `crates/xlog-cuda/kernels/ilp.cu` | 1 | 0 | false | D2H(1) |  |
...
| `crates/xlog-cuda/src/cuda_graph.rs` | 2 | 0 | false | W66(2) |  |
...
| `crates/xlog-cuda/src/device_runtime/mod.rs` | 1 | 0 | false | M1(1) |  |
| `crates/xlog-cuda/src/device_runtime/resource.rs` | 1 | 0 | false | M1(1) |  |
...
| `crates/xlog-cuda/src/memory.rs` | 1 | 0 | false | D2H(1) |  |
...
| `crates/xlog-cuda/src/provider/wcoj.rs` | 33 | 0 | false | W3.1(9), W6.4(9), W3.2(7), D2H(3), S1e(3), D1(2) |  |
...
| `crates/xlog-cuda/src/wcoj_phase_timing.rs` | 1 | 0 | false | D2H(1) |  |
...
| `crates/xlog-cuda/tests/ptx_validation.rs` | 1 | 0 | false | D4(1) |  |
...
| `crates/xlog-cuda/tests/test_d2h_counter.rs` | 1 | 0 | false | D2H(1) |  |
| `crates/xlog-cuda/tests/test_deterministic_d2h_gate.rs` | 3 | 0 | false | D2H(3) |  |
...
| `crates/xlog-cuda/tests/test_wcoj_layout_fast_path.rs` | 2 | 1 | false | D2H(2) | D2H(1) |
...
| `crates/xlog-cuda/tests/test_wcoj_layout_u32.rs` | 1 | 0 | false | D2H(1) |  |
| `crates/xlog-cuda/tests/test_wcoj_layout_u64.rs` | 1 | 0 | false | D2H(1) |  |
| `crates/xlog-cuda/tests/test_wcoj_plan_provider_cert.rs` | 0 | 0 | true |  |  |
| `crates/xlog-cuda/tests/test_wcoj_project.rs` | 2 | 0 | false | W2.1(2) |  |
| `crates/xlog-cuda/tests/test_wcoj_triangle_u32.rs` | 2 | 3 | false | D2H(2) | D2H(3) |
| `crates/xlog-cuda/tests/test_wcoj_triangle_u64.rs` | 2 | 2 | false | D2H(2) | D2H(2) |
...
| `crates/xlog-integration/benches/wcoj_w33_superhub.rs` | 1 | 0 | false | W3.3(1) |  |
...
| `crates/xlog-integration/tests/test_wcoj_executor_wiring.rs` | 1 | 0 | false | D2H(1) |  |
| `crates/xlog-integration/tests/test_wcoj_groupby_fusion.rs` | 5 | 0 | false | S1d(4), D1(1) |  |
| `crates/xlog-integration/tests/test_wcoj_groupby_fusion_recursive.rs` | 1 | 0 | false | D1(1) |  |
| `crates/xlog-integration/tests/test_wcoj_record_join_result_feedback.rs` | 2 | 0 | false | W2.4(2) |  |
| `crates/xlog-integration/tests/test_wcoj_recursive_dispatch.rs` | 24 | 1 | false | W4.1(14), P1(9), W41-13(1) | W41-13(1) |
...
| `crates/xlog-ir/src/plan.rs` | 1 | 0 | false | D2(1) |  |
| `crates/xlog-ir/src/rir.rs` | 9 | 0 | false | W2.1(3), W6.3(3), W2.2(2), D2(1) |  |
| `crates/xlog-ir/tests/test_kclique_variable_order.rs` | 0 | 0 | true |  |  |
| `crates/xlog-ir/tests/test_multiway_plan.rs` | 0 | 0 | true |  |  |
| `crates/xlog-ir/tests/test_multiway_rir.rs` | 1 | 0 | false | D4(1) |  |
...
| `crates/xlog-logic/src/eir.rs` | 0 | 2 | false |  | G91(2) |
...
| `crates/xlog-logic/src/optimizer.rs` | 22 | 0 | false | W2.2(18), D5(2), W3.7(1), G4(1) |  |
...
| `crates/xlog-logic/tests/test_epistemic_faeel_foundedness.rs` | 1 | 0 | false | G91(1) |  |
| `crates/xlog-logic/tests/test_epistemic_g91.rs` | 1 | 4 | false | G91(1) | G91(4) |
...
| `crates/xlog-prob/src/epistemic.rs` | 2 | 0 | false | D4(2) |  |
...
| `docs/ARCHITECTURE.md` | 13 | 7 | false | G91(5), D4(5), P1(1), P2(1), P3(1) | D4(2), D1(2), D2(2), M8(1) |
...
| `docs/whitepaper/sections/01_introduction.tex` | 3 | 0 | false | D4(3) |  |
| `docs/whitepaper/sections/02_architecture.tex` | 4 | 0 | false | D2H(3), D4(1) |  |
| `docs/whitepaper/sections/03_language.tex` | 0 | 0 | true |  |  |
| `docs/whitepaper/sections/04_gpu_datalog.tex` | 1 | 0 | false | D2H(1) |  |
...
| `examples/BFO/universal_case_reasoner/tests/test_production_transfer.py` | 0 | 9 | false |  | v086(8), v085(1) |
...
| `examples/epistemic/13e-nested-modal-chain-g91-accepted.xlog` | 0 | 5 | false |  | G91(5) |
...
| `python/tests/test_ilp_credit_gpu.py` | 2 | 9 | false | D2H(2) | D2H(9) |
...
| `python/tests/test_ilp_sparse_guard.py` | 0 | 3 | false |  | D2H(3) |
