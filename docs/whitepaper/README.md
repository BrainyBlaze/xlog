# xlog v0.8.6 Whitepaper (LaTeX)

arxiv-style single-column LaTeX source for the xlog v0.8.6 technical whitepaper: *"xlog: A GPU-Native Logic Programming Language for Unified Symbolic Reasoning"*.
