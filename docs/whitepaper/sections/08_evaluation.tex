...
\begin{table*}[htbp]
  ...
  \begin{tabularx}{\linewidth}{@{}l X X X X@{}}
    \toprule
    \textbf{Dimension} & \textbf{DeepProbLog} & \textbf{Scallop} & \textbf{GPUlog} & \textbf{xlog} \\
    \midrule
