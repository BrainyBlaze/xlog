...
Every operator also exposes a recorded-launch sibling that routes through the \texttt{LaunchRecorder} preflight/commit discipline of \Cref{sec:arch}, selectable per-operator or via an umbrella flag, with the legacy path as the default.
