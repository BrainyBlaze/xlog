...
Decision-DNNF compilation is the most expensive stage in the pipeline. On the MNIST addition benchmark (\texttt{01\_minimal}, 512 training examples), a cold-start compilation takes approximately 75 seconds. Since this cost is incurred at the beginning of each training epoch in a naive implementation, it can dominate total training time.
